"""Shared fixtures for aggregator-summarize-rank tests.
...
time (aggregator_common.db, aggregator_summarize_rank.loop).
"""
...
def db_engine():
    ...
    with PostgresContainer("postgres:16") as postgres:
        ...
        import aggregator_summarize_rank.loop as loop_mod
...
def db_url(db_engine):
    """Connection URL string for the live test container."""
...
def make_article(
    ...
    *,
    source_id: int,
    dedup_key: str = "key-1",
    status: ArticleStatus = ArticleStatus.pending_ranking,
